...
% Generate the outermost circle of scattered points
...
ZC=ZFunc(h0,r0,Z0);
t0=linspace(.05,1,25)';
% Generate scattered points on branches
...
% Coordinate region modification
...
% Rotating images, falling snowflakes
